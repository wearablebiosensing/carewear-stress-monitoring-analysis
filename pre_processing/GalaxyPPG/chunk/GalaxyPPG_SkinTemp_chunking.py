...
print("\n==============================")
print("GalaxyPPG SkinTemp Chunking Pipeline")
print("==============================\n")
...
input_folder = input("Enter GalaxyPPG merged SkinTemp folder path: ").strip()

output_folder = os.path.join(input_folder, "skintemp_chunks")
...
for file_path in file_list:
    ...
    try:
        ...
        for seg_id, seg_df in df.groupby("segment_id"):
            ...
            output_name = f"activity_id_{label_int}_P{participant_id}_GalaxyWatch_SkinTemp_chunk.csv"
